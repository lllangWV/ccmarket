...
Read `plugins/ralph/commands/run_ralph_rp.md` and write it to `${2:-scripts}/RP_LOOP_PROMPT.md`.

This makes the prompt local to the project so it can be customized.

### Step 3: Copy Shell Script

Read `plugins/ralph/scripts/run_rp_loop.sh` and write it to `${2:-scripts}/run_rp_loop.sh`.
